...
- **Windows**: `findingbridge-v0.1.0-win-x64.exe`
- **macOS**: `findingbridge-v0.1.0-macos-arm64` (Apple Silicon) or `-x64` (Intel)
- **Linux**: `findingbridge-v0.1.0-linux-x64`
...
- "Explain finding fb-001 in simple terms"
...
| Problem | Solution |
|---------|----------|
| Browser doesn't open | Run `findingbridge setup --cli` |
